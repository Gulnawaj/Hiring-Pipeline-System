...
export const advancePipelineStage = async (req, res) => {
  try {
    const { id } = req.params;
    const user = req.user;
...
export const reinstateApplication = async (req, res) => {
  try {
    const { id } = req.params;
    const user = req.user;
...
export const bulkAdvancePipelineStage = async (req, res) => {
  try {
...
export const bulkRejectApplication = async (req, res) => {
  try {
